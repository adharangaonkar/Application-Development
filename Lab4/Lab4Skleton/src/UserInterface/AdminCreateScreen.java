...
public class AdminCreateScreen extends javax.swing.JPanel {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        // TODO add your handling code here:String p1 = txtPword.getText();
        ...
        if(!usernamePatternCorrect()){
            txtUser.setBorder(BorderFactory.createLineBorder(Color.red));
            jLabel1.setForeground(Color.red);
            JOptionPane.showMessageDialog(null,"Username show be in the form of xxx_xxx@xxx.xxx");
           return;
        }
        ...
        if(!passwordPatternCorrect()){
            txtPword.setBorder(BorderFactory.createLineBorder(Color.red));
            jLabel2.setForeground(Color.red);
            JOptionPane.showMessageDialog(null, "Password should be atleast 6 digits and a"+"combination of number, uppercasae,lower case and"
         ...
         if(radioSupplier.isSelected()){
             ...
             JOptionPane.showMessageDialog(null, "Suppler created Successfully");
             toMainScreen();
         }
    ...
    private void radioCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radioCustomerActionPerformed
        ...
        if(!usernamePatternCorrect()){
            JOptionPane.showMessageDialog(null,"Username show be in the form og xxx_xxx@xxx.xxx");
           return;
        }
        if(p1==null || p1.equals("")){
            JOptionPane.showMessageDialog(null, "Password cant be empty");
        ...
        if(!passwordPatternCorrect()){
            JOptionPane.showMessageDialog(null, "PAssword show be atleast 6 digits and a"+"combination of number, uppercasae,lower case and"
                +"special characters $,*,# or&");
            return;
        }
         if(!p1.equals(p2)){
